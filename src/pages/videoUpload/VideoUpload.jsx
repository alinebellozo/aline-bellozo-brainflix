            ...
            <div className="video-upload__container">
                ...
                <div className="video-upload__details">
                    <div className="video-upload__title-container">
                        ...
                        <input className="video-upload__title-input-field" id="input-field" type="text" placeholder="Add a title to your video"></input>
                    </div>
                    <div className="video-upload__description-container">
                        <h4 className="video-upload__description">Add a video description</h4>
                        <textarea className="video-upload__description-input-field" id="input-field" type="text" placeholder="Add a decription to your video"></textarea>
                    </div>
                </div>
            </div>
            <div className="video-upload__button-container">
                <p className="video-upload__cancel">Cancel</p>
                <button className="video-upload__button" type="submit"><img className="video-upload__button-icon" src={PublishVideo} alt="Publish video icon"/>Publish</button>
